...
public class FactoryImpl extends PredefinedImpl implements Factory {
    ...
    public JavaDoc.Tag newJavaDocTag(JavaDoc.TagIdentifier tagIdentifier, String content,
        ...
        return new JavaDocImpl.TagImpl(tagIdentifier, content, null, source, blockTag);
    }
    ...
    @Override
    public Comment newMultilineComment(Source source, String comment) {
        return new MultiLineComment(source, comment);
    }
    ...
    @Override
    public Comment newSingleLineComment(Source source, String comment) {
        return new SingleLineComment(source, comment);
    }
